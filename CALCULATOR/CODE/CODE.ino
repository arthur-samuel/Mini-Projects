#include <LiquidCrystal.h>  //To prepare the LCD for programming
#include  <Keypad.h> //To prepare the keypad for programming
...
void setup() {
  lcd.begin(16,2); //I am using a 16*2 LCD  display
  lcd.print("OLYMPUS"); lcd.setCursor(0,  1);   // set the cursor to column 0, line 1
